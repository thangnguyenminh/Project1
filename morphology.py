# -*- coding: utf-8 -*-
"""
Created on Tue Apr 10 21:43:56 2018
...
def StrahlerOrder(G, root):
    ...
    for e in G.edges():
        ...
        G.edges[e[0], e[1]] ['Strahler'] = s
        s = min(G.node[e[0]]['level'], G.node[e[1]]['level'])
        G.edges[e[0], e[1]] ['level'] = s
...
#     
#     # https://stackoverflow.com/questions/40030481/numpy-savetxt-save-one-column-as-int-and-the-rest-as-floats/40030726
